      ...
      {discountCoupons.map((coupon: any, index: any) => (
        <div className="coupon-card" key={index}>
          ...
          <h3>
            {coupon.disc
              ? coupon.disc
              : `${coupon.persent}% discount available for purchasing ${coupon.min_qty} to ${coupon.max_qty} products.`}
          </h3>
          <div className="coupon-row">
            <span id="cpnCode">Minimum Quantity:</span>
            <span id="cpnBtn">{coupon.min_qty}</span>
          </div>
          <div className="coupon-row">
            <span id="cpnCode">Maximum Quantity:</span>
