...
const HomeScreen = ({ curimage }: any) => {
  ...
  return (
    ...
    <div className="personalisethisproductheading">
      ...
      <select name="optionSelect" id="optionSelect" onChange={handleOptionChange}>
            ...
            <div className="swatch-container">
              ...
              <div className="swatch customily-swatch">
                <input
                  ...
                  className="needsclick needsfocus"
                />
                <label htmlFor="font2" className="needsclick needsfocus">
                  <img
              ...
              <div className="swatch customily-swatch">
                <input
                  ...
                  className="needsclick needsfocus"
                />
                <label htmlFor="font3" className="needsclick needsfocus">
                  <img
              ...
              <div className="swatch customily-swatch">
                <input
                  ...
                  className="needsclick needsfocus"
                />
                <label htmlFor="font4" className="needsclick needsfocus">
                  <img
              ...
              <div className="swatch customily-swatch">
                <input
                  ...
                  className="needsclick needsfocus"
                />
                <label htmlFor="font5" className="needsclick needsfocus">
                  <img
